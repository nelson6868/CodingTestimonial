 ...
 function CustomerSecondTestimonial() {
  return (
    ...
    <div className="card col-md-3 col-11"  style={{float:"left"}}>
        <div className="card-content">
            <div class="card-body p-0">
                ...
                <div className="profile mb-4 mt-3">   <img src={JosephIke} alt="josephIke" /> </div>
    ...
    <div className="card col-md-3 col-11 second" style={{float:"left"}}>
        <div className="card-content">
            <div className="card-body p-0">
                <div className="profile mb-4 mt-3"><img src={Adetola} alt="Adetola" /></div>
    ...
    <div class="card col-md-3 col-11 third">
        <div className="card-content">
            <div className="card-body p-0">
                <div className="profile mb-4 mt-3">  <img src={Emmanuel} alt="Emmanuel" /></div>
                <span className="name">Joseph Ike</span>
                <div className="_row">
